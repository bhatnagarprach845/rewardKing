    ...
    *//**
    ...
    public ResponseEntity<String> handleWebhook(
        ...
        try {
            ...
            Optional<RewardTransaction> txOpt = transactionRepository.findByRazorpayPayoutId(rzpPayoutId);
            ...
            RewardTransaction tx = txOpt.get();
            ...
            if ("payout.processed".equals(eventType)) {
                ...
                deductWallet(tx);
                tx.setStatus(RewardTransaction.TransactionStatus.SETTLED);
                ...
                refundWallet(tx);
                tx.setStatus(RewardTransaction.TransactionStatus.FAILED);
